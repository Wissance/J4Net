...
using MemberInfo = Wissance.J4Net.Reflection.Members.MemberInfo;

namespace Wissance.J4Net.Reflection.Properties
{
    public abstract class PropertyInfo : MemberInfo
    {
		...
		private sealed class ParameterInfoImpl : ParameterInfo
		{
			...
			public override CustomModifiers GetCustomModifiers()
			{
				return property.PropertySignature.GetParameterCustomModifiers(parameter);
			}

			public override bool TryGetFieldMarshal(out FieldMarshal fieldMarshal)
			{
